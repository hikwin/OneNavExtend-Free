                    ...
                    <div id="search" class="s-search mx-auto">
                        ...
                        <div id="search-list" class="hide-type-list">
                            ...
                            <div class="search-group group-b ">
                                <ul class="search-type">
                                    <li><input hidden="" type="radio" name="type" id="type-baidu1" value="https://swisscows.com/en/web?query=" data-placeholder="奶牛搜索">
                                        <label for="type-baidu1"><span class="text-muted">奶牛</span></label>
                                    </li>
                                    <li><input hidden="" type="radio" name="type" id="type-google1" value="https://yandex.com/search/?text=" data-placeholder="Yandex搜索">
                                        <label for="type-google1"><span class="text-muted">Yandex</span></label>
                                    </li>
                            ...
                            <div class="search-group group-e ">
                                <ul class="search-type">
                                    ...
                                    <li>
                                        <input hidden="" type="radio" name="type" id="type-12306" value="https://www.mafengwo.cn/search/q.php?q=" data-placeholder="马蜂窝旅游">
                                        <label for="type-12306"><span class="text-muted">马蜂窝</span></label>
                                    </li>
                                    <li>
                                        <input hidden="" type="radio" name="type" id="type-kd100" value="https://m.kuaidi100.com/result.jsp?com=hywuliu&nu=" data-placeholder="快递100">
                                        <label for="type-kd100"><span class="text-muted">快递100</span></label>
                                    </li>
                                    <li>
                                        <input hidden="" type="radio" name="type" id="type-qunar" value="https://travel.qunar.com/search/all/" data-placeholder="去哪儿">
                            ...
                            <div class="search-group group-f ">
                                <ul class="search-type">
									...
									<li>
									    <input hidden="" type="radio" name="type" id="type-boss" value="https://www.zhipin.com/web/geek/job?query=" data-placeholder="Boss直聘">
									    <label for="type-boss"><span class="text-muted">Boss</span></label>
									</li>
                                </ul>
                            </div>
                        </div>
...
<script>
!function(p){"use strict";!function(t){var s=window,e=document,i=p,c="".concat("https:"===e.location.protocol?"https://":"http://","sdk.51.la/js-sdk-pro.min.js"),n=e.createElement("script"),r=e.getElementsByTagName("script")[0];n.type="text/javascript",n.setAttribute("charset","UTF-8"),n.async=!0,n.src=c,n.id="LA_COLLECT",i.d=n;var o=function(){s.LA.ids.push(i)};s.LA?s.LA.ids&&o():(s.LA=p,s.LA.ids=[],o()),r.parentNode.insertBefore(n,r)}()}({id:"JP44M2506DrnNDAn",ck:"JP44M2506DrnNDAn"});
</script>
</html>