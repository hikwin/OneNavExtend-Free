...
<head>
  ...
  <?php echo'<style type="text/css">.layui-form-item {margin-bottom: 5px;}.layui-form-label {width: 60px;}.layui-input-block {margin-left: 90px;}</style>';?>
...
<div class="layui-row" >
	<div class="" style="">
    <div class="" style="width: 98%; margin-top: 10px; margin-bottom: 5px;" >
...
<script src = "./templates/admin/static/embed.js?v=<?php echo time(); ?>"></script>
